...
package projet_data.jb_feature_dev1_0_1;
...
/**
 * Job: JB_FEATURE_DEV1 Purpose: <br>
 * Description:  <br>
 * @author mohamed.dlimi_external@keyrus.com
 * @version 7.3.1.20210623_0656-patch
 * @status 
 */
public class JB_FEATURE_DEV1 implements TalendJob {
	static {System.setProperty("TalendJob.log", "JB_FEATURE_DEV1.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(JB_FEATURE_DEV1.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "JB_FEATURE_DEV1";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_GSfxIBqoEe6-vp6YRPzEmA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				JB_FEATURE_DEV1.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(JB_FEATURE_DEV1.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = JB_FEATURE_DEV1.class.getClassLoader()
					.getResourceAsStream("projet_data/jb_feature_dev1_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = JB_FEATURE_DEV1.class.getClassLoader()
 ...
 */
    ...
    public static void main(String[] args){
        final JB_FEATURE_DEV1 JB_FEATURE_DEV1Class = new JB_FEATURE_DEV1();

        int exitCode = JB_FEATURE_DEV1Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'JB_FEATURE_DEV1' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
        	...
        	log.info("TalendJob: 'JB_FEATURE_DEV1' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = JB_FEATURE_DEV1.class.getClassLoader().getResourceAsStream("projet_data/jb_feature_dev1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = JB_FEATURE_DEV1.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : JB_FEATURE_DEV1");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     39097 characters generated by Talend Cloud Real-Time Big Data Platform 
 *     on the 4 juillet 2023 22:48:28 CEST
 ************************************************************************************************/